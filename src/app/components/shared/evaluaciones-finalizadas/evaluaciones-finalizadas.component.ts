...
import { ModalAsignarPostulantesComponent } from '../modales/modal-postulante/modal-asignar-postulantes/modal-asignar-postulantes.component';
import { ModalAdministrarPuestoComponent } from '../../admin/modales/modal-administrar-puesto/modal-administrar-puesto.component';

@Component({
  selector: 'app-evaluaciones-finalizadas',
  imports: [CommonModule, MatPaginatorModule, FormsModule],
  templateUrl: './evaluaciones-finalizadas.component.html',
  styleUrl: './evaluaciones-finalizadas.component.css'
})
export class EvaluacionesFinalizadasComponent implements OnInit {
