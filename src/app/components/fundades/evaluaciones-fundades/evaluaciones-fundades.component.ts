...
@Component({
  selector: 'app-evaluaciones-fundades',
  imports: [CommonModule, MatPaginatorModule, FormsModule],
  templateUrl: './evaluaciones-fundades.component.html',
  styleUrl: './evaluaciones-fundades.component.css',
  providers: [
    { provide: MatPaginatorIntl, useValue: getCustomPaginatorIntl() },
  ],
})
export class EvaluacionesFundadesComponent implements OnInit {
  ...
  editarPuesto(puesto: PuestosTrabajo): void {
    ...
    dialogRef.afterClosed().subscribe((resultado) => {
      if (resultado) {
        ...
        // recargar y filtrar
        this.puestosService
          .listarPuestosPendientesByEmpresaId(this.miEmpresa.id)
          .subscribe((todas) => {
