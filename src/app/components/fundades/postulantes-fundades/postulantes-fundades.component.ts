...
import { ModalPostulanteFindDniComponent } from '../../shared/modales/modal-postulante/modal-postulante-find-dni/modal-postulante-find-dni.component';
import { ModalExitoComponent } from '../../shared/modales/modal-exito/modal-exito.component';
import { ModalPostulanteFormComponent } from '../../shared/modales/modal-postulante/modal-postulante-form/modal-postulante-form.component';
import { ModalConfirmacionComponent } from '../../shared/modales/modal-confirmacion/modal-confirmacion.component';

@Component({
  selector: 'app-postulantes-fundades',
  imports: [CommonModule, MatPaginatorModule, FormsModule],
  templateUrl: './postulantes-fundades.component.html',
  styleUrl: './postulantes-fundades.component.css',
  providers: [
    { provide: MatPaginatorIntl, useValue: getCustomPaginatorIntl() },
  ],
})
export class PostulantesFundadesComponent implements OnInit {
