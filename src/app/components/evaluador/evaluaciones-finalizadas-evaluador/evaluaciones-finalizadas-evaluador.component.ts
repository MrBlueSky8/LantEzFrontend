...
@Component({
  selector: 'app-evaluaciones-finalizadas-evaluador',
  imports: [CommonModule, MatPaginatorModule, FormsModule],
  templateUrl: './evaluaciones-finalizadas-evaluador.component.html',
  styleUrl: './evaluaciones-finalizadas-evaluador.component.css'
})
export class EvaluacionesFinalizadasEvaluadorComponent implements OnInit {
    ...
    this.usuarioService
     ...
     this.usuarioService
      ...
      .subscribe({
        next: (id) => {
          this.userId = id;
          this.puestosService.listarFinalizadosByUsuarioId(this.userId).subscribe({
  ...
  editarPuesto(puesto: PuestosTrabajo): void {
    ...
    dialogRef.afterClosed().subscribe((resultado) => {
      if (resultado) {
        ...
        // recargar y filtrar
        this.puestosService
          .listarFinalizadosByUsuarioId(this.userId)
          .subscribe((todas) => {
