...
@Component({
  ...
  templateUrl: './evaluaciones-evaluador.component.html',
  styleUrl: './evaluaciones-evaluador.component.css',
  providers: [
    { provide: MatPaginatorIntl, useValue: getCustomPaginatorIntl() },
  ],
})
export class EvaluacionesEvaluadorComponent implements OnInit {
    ...
    this.usuarioService
     ...
     this.usuarioService
      ...
      .subscribe({
        next: (id) => {
          this.userId = id;
          this.puestosService.listarPendientesAprobadosByUsuarioId(this.userId).subscribe({
  ...
  editarPuesto(puesto: PuestosTrabajo): void {
    ...
    dialogRef.afterClosed().subscribe((resultado) => {
      if (resultado) {
        ...
        // recargar y filtrar
        this.puestosService
          .listarPendientesAprobadosByUsuarioId(this.userId)
          .subscribe((todas) => {
