...
@Component({
  selector: 'app-sublevel-evaluador-menu',
  imports: [CommonModule, RouterLink, RouterModule, SublevelEvaluadorMenuComponent],
  template: `
    <ul
      ...
      <li *ngFor="let item of data.items" class="sublevel-nav-item">
        ...
        <a
          ...
          *ngIf="!item.items || (item.items && item.items.length === 0)"
          [routerLink]="item.routeLink ? [item.routeLink] : null"
...
export class SublevelEvaluadorMenuComponent implements OnInit {
