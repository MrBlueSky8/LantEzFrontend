...
import { SublevelAdminMenuComponent } from './sublevel-admin-menu.component';
...
@Component({
  ...
  imports: [CommonModule, RouterLink, RouterModule, RouterOutlet, SublevelAdminMenuComponent],
