...
@Component({
  selector: 'app-sublevel-admin-menu',
  imports: [CommonModule, RouterLink, RouterModule, SublevelAdminMenuComponent],
  template: `
    <ul
...
export class SublevelAdminMenuComponent implements OnInit {
